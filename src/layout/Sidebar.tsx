        ...
        return [
          ...
          },
          {
            ...
            items: [
              ...
              { id: "ubicacion", label: "Ubicación Comunal", icon: MapPin },
            ],
          },
          {
         ...
         {isSidebarOpen ? (
           <>
               <div className="flex items-center gap-4 p-4 rounded-3xl bg-slate-50 border border-slate-100">
                  ...
                  <div className="flex-1 min-w-0">
                     ...
                     <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mt-0.5">
                       {user.role === 'alcaldesa' ? 'Alcaldesa' : 
                        user.role === 'secretario' ? 'Secretario de Gobierno' :
                        user.role === 'director' ? 'Director de Área' :
                        user.role === 'sala_autogobierno' ? 'Coordinador de Sala' :
                        'Vocero Responsable'}
                     </p>
                  </div>
               </div>
            ...
            <div className="flex flex-col items-center gap-4">
               <button onClick={onLogout} className="p-3 rounded-xl text-rose-400 hover:bg-rose-50 transition-all border border-transparent hover:border-rose-100 bg-white shadow-sm">

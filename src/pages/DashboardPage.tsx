    ...
    <div className="space-y-8 pb-12">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm shadow-gray-200/40">
            <div className="mb-8 flex items-center justify-between">
               <h2 className="text-lg font-bold text-gray-900 border-l-4 border-brand-primary pl-4">Actividades Recientes</h2>
              ...
              {[1, 2, 3].map(i => (
                <div key={i} className="flex gap-4 rounded-xl border border-gray-50 p-4 transition-all hover:border-brand-primary/10 hover:bg-gray-50/50 group">
                   ...
                   <div className="flex-1">
                      <h4 className="text-sm font-bold text-gray-800">Actualización de Vocería - C.C. El Trigo</h4>
                   ...
                   <div className="flex items-center">
                     <span className="rounded-lg bg-green-50 px-3 py-1 text-[10px] font-bold text-green-700 uppercase tracking-tight border border-green-100">Completado</span>
                   </div>
                </div>
              ))}
            </div>
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm shadow-gray-200/40 overflow-hidden relative">
            <div className="flex items-start justify-between">
              <div>
                <h2 className="text-lg font-bold text-gray-900 border-l-4 border-brand-primary pl-4 tracking-tight">Estado de Participación</h2>
            ...
            <div className="mt-12 flex items-end gap-2.5 h-32 px-4">
        ...
        <div className="space-y-6">
          <div className="rounded-3xl bg-brand-secondary p-8 text-white shadow-xl shadow-brand-primary/10 relative overflow-hidden group">
            ...
            {/* Abstract decorative element from design theme */}

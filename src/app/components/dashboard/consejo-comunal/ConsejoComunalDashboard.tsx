...
import { MapaSuenos } from "./secciones-sidebar/MapaSuenos"; // Nueva Importación
...
type Section =
  ...
  | "censo"
  | "ubicacion"
  | "mapa_suenos" // Nuevo ID de sección
  | "aca"
  | "nudos"
  | "proyectos"
  | "asambleas"
  ...
  return (
    <div className="flex bg-[#fcfdfe] min-h-screen">
      ...
      <main className="flex-1 w-full lg:max-w-[calc(100vw-64px)] overflow-hidden">
        <DashboardNavbar 
          user={user}
          title={activeSection === "mapa_suenos" ? "Mapa de los Sueños" : activeSection.charAt(0).toUpperCase() + activeSection.slice(1)}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {activeSection === "inicio" && (
                <DashboardOverview
                  user={user}
                  onNavigate={(s, a) => navigateWithAction(s as Section, a || null)}
                />
              )}

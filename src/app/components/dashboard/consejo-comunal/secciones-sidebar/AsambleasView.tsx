  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm flex flex-col md:flex-row items-center gap-8">
        <div className="h-16 w-16 rounded-2xl bg-indigo-50 flex items-center justify-center text-brand-primary shadow-lg shadow-brand-primary/10 shrink-0">
        ...
        <button 
          ...
          className="md:ml-auto px-6 py-3.5 rounded-2xl bg-brand-primary text-white text-[10px] font-black uppercase tracking-widest shadow-xl shadow-brand-primary/20 hover:scale-105 active:scale-95 transition-all"
        >
          Nueva Convocatoria
        </button>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 space-y-6 shadow-sm">
           <h4 className="text-[11px] font-black text-slate-800 uppercase tracking-widest italic flex items-center gap-2">
              <Clock className="h-4 w-4 text-brand-primary" /> Próximas Asambleas
           </h4>
           <div className="p-6 rounded-3xl bg-gray-50 border border-gray-100 flex items-center justify-between group cursor-pointer hover:border-brand-primary/30 transition-all">
              ...
              <button className="text-[9px] font-black text-brand-primary uppercase tracking-widest underline italic">Confirmar</button>
           </div>
        </div>
                  ...
                  <form className="space-y-6">
                     ...
                     <div className="p-6 rounded-[2rem] bg-indigo-50 border border-indigo-100 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                           ...
                           <p className="text-[10px] font-black text-brand-primary uppercase italic">¿Habilitar registro en Vivo?</p>
                        </div>
                        <input type="checkbox" className="h-5 w-5 rounded border-brand-primary text-brand-primary focus:ring-brand-primary" />
                     </div>

                     <button className="w-full py-5 rounded-2xl bg-brand-primary text-white text-[11px] font-black uppercase tracking-widest shadow-xl shadow-brand-primary/20 active:scale-95 transition-all">

  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button className="flex items-center gap-2 rounded-xl bg-[#E31C1C] px-5 py-2.5 text-sm font-bold text-white shadow-lg hover:scale-[1.02] transition-all">
              ...
              return (
                <div key={d} className="bg-white min-h-[100px] p-2 hover:bg-gray-50 transition-colors group relative">
                  <span className={cn(
                    ...
                    d === 21 ? "bg-[#E31C1C] text-white" : "text-slate-600"
                  )}>
                    {d}
                  </span>
          ...
          <div className="bg-[#1A1A1A] rounded-3xl p-8 text-white">
            ...
            <div className="space-y-4">
               <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/10 border border-white/10">
                  <div className="h-10 w-10 rounded-xl bg-[#E31C1C] flex items-center justify-center shrink-0">
